...
- This project has been tested on both an unmanaged Kubernetes cluster (v1.9+) and on AKS (Kubernetes v1.8.10).  Both managed and unmanaged Kubernetes clusters can be easily deployed on Azure.
